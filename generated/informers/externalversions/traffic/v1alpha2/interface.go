...
// RoutePolicies returns a RoutePolicyInformer.
func (v *version) RoutePolicies() RoutePolicyInformer {
	return &routePolicyInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
