	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.TrafficV1alpha2().Routes(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TrafficV1alpha2().Routes(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *routeInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&trafficv1alpha2.Route{}, f.defaultInformer)
}

func (f *routeInformer) Lister() v1alpha2.RouteLister {
	return v1alpha2.NewRouteLister(f.Informer().GetIndexer())
}
